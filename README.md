...
PDF is **not** committed — version **v0.81** from `welvet/README.md`, upload `dist/welvet-feature-book-v0.81.pdf` to [GitHub Releases](https://github.com/openfluke/openfluke.github.io/releases).
