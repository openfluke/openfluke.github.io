...
PDF is **not** committed — version **v0.95.1** from `welvet/README.md`, upload `dist/welvet-feature-book-v0.95.1.pdf` to [GitHub Releases](https://github.com/openfluke/openfluke.github.io/releases).
