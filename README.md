...
PDF is **not** committed — version **v1.0.1** from `welvet/README.md`, upload `dist/welvet-feature-book-v1.0.1.pdf` to [GitHub Releases](https://github.com/openfluke/openfluke.github.io/releases).
